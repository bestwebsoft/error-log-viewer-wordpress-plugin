							...
							<table class="form-table">
								<tr valign="top">
									...
									<?php if ( file_exists( $php_error_path ) ) { ?>
										<td>
											<?php if ( filesize( $php_error_path ) == 0 ) 
				...
				<form method="post" action="admin.php?page=rrrlgvwr.php&amp;tab=logmonitor">
						...
						<tr valign="top">
							...
							<td>
								<fieldset>
									...
									<?php if ( filesize( $rrrlgvwr_options['error_log_path'] ) > 10485760 ) : ?>
										<div class="hide-if-js rrrlgvwr-date-search-mes">
					...
					<?php if ( ! empty( $rrrlgvwr_options['error_log_path'] ) ) : ?>
						<textarea name="rrrlgvwr_newcontent" class="large-text code" rows="16" readonly="readonly">
							<?php if ( isset ( $_POST['rrrlgvwr_submit_show_content'] ) ) { 
						...
						<?php if ( $rrrlgvwr_options['error_log_path'] != $php_error_path ) : ?>
							<table class="form-table">
								<tr valign="top">
									<th scope="row">
...
if ( ! function_exists( 'rrrlgvwr_edit_htaccess' ) ) { 
	function rrrlgvwr_edit_htaccess() { 
		...
		if ( @is_writable( $file ) ) { 
			...
			if ( strstr( file_get_contents( $file ), $string ) == false ) { 
